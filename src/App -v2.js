    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MoviesList movies={movies} SelectedMovie={handleSelectMovie} />
          )}
...
function WatchedBox() {
  ...
  return (
    <div className="box">
      ...
      {isOpen2 && (
        <>
          <WatchSummary watched={watched} setWatched={setWatched} />
...
function MoviesList({ movies, SelectedMovie }) {
  return (
    <ul className="list list-movies">
      {movies?.map((movie) => (
        <Movie movie={movie} onSelectedMovie={SelectedMovie} />
      ))}
    </ul>
  );
}
          ...
          <section>
            <div className="rating">
              {!movieAlreadyRated ? (
                ...
                <p>
                  You Already Reated this Movie {watchedUserrating}
                  <span>⭐</span>
                </p>
              )}
            </div>
